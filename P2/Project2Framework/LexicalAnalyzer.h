...
extern "C"
{
	LexicalAnalyzer* LexicalAnalyzer_new(char* filename) { return new LexicalAnalyzer(filename); }
	// Deconstructor?
	token_type LexicalAnalyzer_token_type(LexicalAnalyzer* lex) { return lex->GetToken(); }
	char* LexicalAnalyzer_GetTokenName(LexicalAnalyzer* lex, token_type t) { return lex->GetTokenName(t); }
